...
insert into Carte(solde,dateCreation,activee,matricule) values(1.0,current_date(),True,1) ;
...
insert into JourFerier(jour, description, activee) values( '2022-01-01', 'Jour de l an', True ) ;
insert into JourFerier(jour, description, activee) values( '2022-05-01', 'Fête du travail', True) ;
insert into JourFerier(jour, description, activee) values( '2022-05-08', '8 Mai 1945', True) ;
insert into JourFerier(jour, description, activee) values( '2022-07-14', 'Fête nationnal', True) ;
insert into JourFerier(jour, description, activee) values( '2022-08-15', 'Assomption', True) ;
insert into JourFerier(jour, description, activee) values( '2022-11-01', 'Tousaint', True) ;
insert into JourFerier(jour, description, activee) values( '2022-11-11', 'Armistice', True) ;
insert into JourFerier(jour, description, activee) values( '2022-12-25', 'Noël' , False) ;